...
for i in $(seq 1 $iter_num); do
    ...
    accelerate launch m_sft_test.py --deepspeed deepspeed_configs/deepspeed_2.json --model_name $e_input_model --attn_implementation eager --per_device_train_batch_size 2 --gradient_accumulation_steps 8 --train_set_path $dataset_path --output_dir $m_model_dir --hub_model_id $m_hub_id
    conda deactivate
done